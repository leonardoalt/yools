...
(define-const _1 (_ BitVec 256) (_ bv1 256))
(define-const _2 (_ BitVec 256) (_ bv2 256))
...
(define-const _exe_pos_8128_3 (_ BitVec 256) (ite (and (= _revert_flag_2070_0 (_ bv0 256)) (= _stop_flag_2069_0 (_ bv0 256))) (_ bv2 256) _exe_pos_8128_2))
...
(define-const _exe_pos_8128_4 (_ BitVec 256) (ite (and (= _revert_flag_2070_0 (_ bv0 256)) (= _stop_flag_2069_0 (_ bv0 256))) (_ bv3 256) _exe_pos_8128_3))
