...
(define-const _5 (_ BitVec 256) (_ bv5 256))
(define-const _6 (_ BitVec 256) (ite (bvugt x_2_1 _5) (_ bv1 256) (_ bv0 256)))
(assert (and (and (= _revert_flag_2070_0 (_ bv0 256)) (= _stop_flag_2069_0 (_ bv0 256))) (and (not (= _4 (_ bv0 256))) (not (not (= x_2_1 (_ bv10 256))))) (= _6 (_ bv0 256))))
