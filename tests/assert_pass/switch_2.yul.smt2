...
(define-const r_3_5 (_ BitVec 256) (ite (not (= x_2_1 (_ bv1 256))) r_3_3 r_3_4))
(define-const t_4_4 (_ BitVec 256) (ite (not (= x_2_1 (_ bv1 256))) t_4_3 t_4_1))
(define-const _6 (_ BitVec 256) (_ bv0 256))
(define-const _7 (_ BitVec 256) (ite (= r_3_5 _6) (_ bv1 256) (_ bv0 256)))
(define-const _8 (_ BitVec 256) (_ bv0 256))
(define-const _9 (_ BitVec 256) (ite (= t_4_4 _8) (_ bv1 256) (_ bv0 256)))
