...
(define-const r_3_2 (_ BitVec 256) t_4_1)
(define-const r_3_3 (_ BitVec 256) (ite (not (= x_2_1 (_ bv1 256))) r_3_1 r_3_2))
(define-const _4 (_ BitVec 256) (_ bv0 256))
(define-const _5 (_ BitVec 256) (ite (= r_3_3 _4) (_ bv1 256) (_ bv0 256)))
(define-const _6 (_ BitVec 256) (_ bv0 256))
(define-const _7 (_ BitVec 256) (ite (= t_4_1 _6) (_ bv1 256) (_ bv0 256)))
(define-const _8 (_ BitVec 256) (bvand _5 _7))
(assert (and (and (= _revert_flag_2070_0 (_ bv0 256)) (= _stop_flag_2069_0 (_ bv0 256))) true (= _8 (_ bv0 256))))
