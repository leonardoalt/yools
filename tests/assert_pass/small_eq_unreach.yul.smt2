...
(define-const _stop_flag_2069_1 (_ BitVec 256) (ite (and (= _revert_flag_2070_0 (_ bv0 256)) (= _stop_flag_2069_0 (_ bv0 256))) (_ bv1 256) _stop_flag_2069_0))
(define-const _2 (_ BitVec 256) (_ bv1 256))
(define-const _3 (_ BitVec 256) (ite (= x_2_1 _2) (_ bv1 256) (_ bv0 256)))
(assert (and (and (= _revert_flag_2070_0 (_ bv0 256)) (= _stop_flag_2069_1 (_ bv0 256))) true (= _3 (_ bv0 256))))
